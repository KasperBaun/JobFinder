...
export const setup: Messages['setup'] = {
  ...
  addressLabel: 'Hjemmeadresse',
  addressPlaceholder: 'valgfrit — f.eks. Rådhuspladsen 1, 1550 København V',
  addressNote: 'Valgfrit, kun danske adresser — job længere væk end din maks. afstand bliver frasorteret.',
  radiusLabel: 'Maks. afstand (km)',
