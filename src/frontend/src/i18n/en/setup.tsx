export const setup = {
  ...
  addressPlaceholder: 'optional — e.g. Rådhuspladsen 1, 1550 København V',
  addressNote: 'Optional, Danish addresses only — jobs farther than your max distance are filtered out.',
  radiusLabel: 'Max distance (km)',
