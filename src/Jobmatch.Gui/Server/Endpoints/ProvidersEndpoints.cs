...
public static class ProvidersEndpoints
{
    public static void Map(WebApplication app)
    {
        ...
        app.MapPost(Routes.Providers.Create, (ProviderUpsert? req, Jobmatch.UserContext ctx) => ProvidersHandler.Create(req, ctx));
        app.MapPut(Routes.Providers.Update, (int id, ProviderUpsert? req, Jobmatch.UserContext ctx) => ProvidersHandler.Update(id, req, ctx));
        app.MapDelete(Routes.Providers.Delete, (int id, Jobmatch.UserContext ctx) => ProvidersHandler.Delete(id, ctx));
