...
Guidelines for implementing background job processing using Hangfire with EntityHook integration.

## Rules  

- ✅ Use Hangfire for reliable background job processing
- ✅ Configure SQL Server storage for job persistence
...
- **Development**: `http://localhost:5082/hangfire`
